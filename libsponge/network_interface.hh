...
class NetworkInterface {
  private:
    ...
    std::unordered_map<uint32_t, std::pair<size_t, EthernetAddress>> mapping{};
    std::unordered_map<uint32_t, size_t> last_arp{};
    std::unordered_map<uint32_t, std::vector<EthernetFrame>> wait_queue{};
    size_t time_now;
